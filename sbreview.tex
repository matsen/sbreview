...
It absolutely requires molecular methods because microbes are now primarily identified by their molecular sequences, and identification of microbes by their molecular sequences is much more straightforward to do in high throughput than morphological or phenotypic characterization.
...
The (unweighted and unrooted) PD of a set of taxa $S$ is simply the total of the lengths of the branches which connect taxa in $S$ \citet{faith1992conservation}.
