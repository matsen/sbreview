...
\forarxiv{
\begin{wrapfigure}[23]{r}{2.5in}
  % \capstart
  \vspace{-27pt}
  \begin{center}
    \includegraphics[width=2.5in]{figures/pd.pdf}
  \end{center}
  \vspace{-10pt}
  \caption{\pdLegend}
  \label{fig:pd}
...
Phylogenetic diversity (PD) measures use the structure and branch lengths of a phylogenetic tree to measure the diversity of a sample (Fig.~\ref{fig:pd}).
...
Abundance-weighted measures take a sum of branch lengths weighted by abundance, such that branches that connect abundant taxa get a higher weight than ones that do not.
...
\noindent
Figure \ref{fig:pd}: \pdLegend

\noindent
Figure \ref{fig:unifrac}: \unifracLegend

\noindent
Figure \ref{fig:dirtpiles}: \dirtpilesLegend
