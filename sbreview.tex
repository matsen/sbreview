...
\citet{evans2012phylogenetic} showed that weighted UniFrac is in fact a specific case of the earth-movers distance, that it can be calculated in linear time in contrast to many applications of the earth-movers distance, and that the commonly-used randomization procedure to attach a p-value to an observed distance has a central limit theorem approximation as a Gaussian process.
