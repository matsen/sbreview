...
Changes in diet very quickly shift its composition, and there is a strong correlation between long-term diet and microbiome \citep{wu2011linking}.
...
For simply separating two rather different samples, rather few samples are needed \citep{kuczynski2010microbial}.
This has led to desire for massive parallelization (cite).
...
Some groups have reported advantages to using alternate single-copy genes as markers, (e.g. \citep{case2007rpob},\citep{mcnabb2004hsp65}), however nothing has really come close to 16S.
...
Whole-genome sequencing used for microbial outbreak tracking \citep{snitkin2012tracking}.
