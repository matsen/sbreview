...
The scale of the data has motivated strategies to insert sequences into a tree.
Although such insertion has a long history as a means to sequentially build a phylogenetic tree NNN farris
, the first software with insertion specifically as a goal was by \citep{ludwig2004arb}.
Other analogous methods have been used \citep{wu2008simple}.
