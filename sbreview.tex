...
The (unweighted) PD of a set of taxa $S$ in an unrooted phylogenetic tree is simply the total of the lengths of the branches that sit between taxa in $S$ \citep{faith1992conservation}.
