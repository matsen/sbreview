...
Noah-- AFAIK nobody has done phylogenetic modeling of primer bias, which would seem to be very useful! Couldn't we check for phylogenetic signal and if there is some, do modeling? I mean, there has got to be some phylogenetic signal, right?
...
I am also grateful to Aaron Darling, David Fredricks, Noah Hoffman, Connor McCoy, Martin Morgan, and Sujatha Srinivasan for interesting discussions that informed this review, and to the NIH (R01 HG005966-01) and NSF (1223057) for financial support.
